...

{
  ...
  programs.firefox = {
    ...
    preferences = {
      ...
      "webgl.disabled" = true;
      "geo.enabled" = false;
      "privacy.firstparty.isolate" = true;  # isole les cookies du domaine propriétaire
      "privacy.resistFingerprinting" = true; # résiste à l'empreinte du navigateur
      "privacy.trackingprotection.fingerprinting.enabled" = true; # idem
